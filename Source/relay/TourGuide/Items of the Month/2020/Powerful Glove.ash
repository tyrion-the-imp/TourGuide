...
void IOTMPowerfulGloveGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    resource_entries.listAppend(ChecklistEntryMake("__item Powerful Glove", url, ChecklistSubentryMake(chargeLeft + "% Powerful Glove battery charge", "", description), -40).ChecklistEntrySetIDTag("Powerful glove skills resource"));
}
