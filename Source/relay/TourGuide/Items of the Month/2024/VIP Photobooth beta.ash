...
void IOTMVIPPhotoBoothGenerateResourceBeta(ChecklistEntry [int] resource_entries)
{
	...
	resource_entries.listAppend(ChecklistEntryMake("__item badge of authority", url, ChecklistSubentryMake(sheriffings + " Sheriff Authority free kill(s) BETA", description), 5));
	}
}