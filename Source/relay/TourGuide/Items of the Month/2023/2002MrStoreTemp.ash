...
void IOTM2002MrStoreGenerateResourceTemp(ChecklistEntry [int] resource_entries)
{
	...
	//https://wiki.kingdomofloathing.com/2002_Mr._Store
	description.listAppend("<a href='https://wiki.kingdomofloathing.com/2002_Mr._Store' target='_blank'><span style='color:blue; font-size:100%; font-weight:normal;'>2002 Mr. Store merch</span></a><br><span style='color:red; font-size:100%; font-weight:bold;'>Credits disappear on rollover.</span>");
