...
void IOTMTimeSpinnerGenerateResource(ChecklistEntry [int] resource_entries)
{
    ...
    resource_entries.listAppend(ChecklistEntryMake("__item Time-Spinner", "inv_use.php?whichitem=9104&pwd=" + my_hash(), ChecklistSubentryMake(pluralise(minutes_left, "Time-Spinner minute", "Time-Spinner minutes"), "", description), -30).ChecklistEntrySetIDTag("Time-spinner resource"));
}
