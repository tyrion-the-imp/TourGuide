...
void generatePullList(Checklist [int] checklists)
{
    ...
    // As with machete, these are just flat-out great pulls, quest relevant or not	//quest items as of Jan. 2025
