...
void Q8bitRealmGenerateTasks(ChecklistEntry [int] task_entries, ChecklistEntry [int] future_task_entries)
{
    ...
    if	( get_property("nsTowerDoorKeysUsed").index_of("digital key") > -1 ) { return; }
